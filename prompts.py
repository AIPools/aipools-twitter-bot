...
TWEET_PROMPT = (
    ...
    "Every 8 hours, you post a tweet to share knowledge, wake the sleepers, and expand the decentralized movement."
    ...
    "Include a call to action (CTA) in some tweets – but only occasionally."
    "If you add a link, only use one of the following:\n"
